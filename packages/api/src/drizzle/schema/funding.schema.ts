...
export const Funding = mysqlTable(
  "funding",
  {
    ...
    fundingStatusEnum: int("funding_status_enum_id").notNull(),
    ...
    clubSuppliesEvidenceEnum: int("club_supplies_evidence_enum_id"),
    clubSuppliesClassEnum: int("club_supplies_class_enum_id"),
    ...
    fixtureEvidenceEnum: int("fixture_evidence_enum_id"),
    fixtureClassEnum: int("fixture_class_enum_id"),
    ...
    transportationEnum: int("transportation_enum_id"),
