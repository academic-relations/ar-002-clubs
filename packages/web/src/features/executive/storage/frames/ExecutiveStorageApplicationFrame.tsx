...
export interface ClubStorageApplicationDetail {
  data: ApiSto005ResponseOk;
}

export const ExecutiveStorageApplicationFrame: React.FC<
  ClubStorageApplicationDetail
> = ({ data }: ClubStorageApplicationDetail) => {
  ...
  return (
    <Card padding="32px" gap={20} outline>
      <StorageDetailFrameInner>
        ...
        {data?.nonStandardItems.length && data?.nonStandardItems.length > 0 ? (
          <>
            <Typography
              key="orderInfo"
              fs={16}
