...
import type { RawClubsData } from "@sparcs-clubs/web/types/clubs.types";

// mockup model to interface
const mockupData: Array<RawClubsData> = [
  {
    id: 1,
    name: "궁극의 맛",
    characteristic: "요리",
  ...
  },
  {
    id: 92,
    name: "카이시엘",
    characteristic: "제과제빵 활동을 통해 학우들의 다양한 문화활동을 장려함.",
    type: "가동아리",
    representative: "김나연",
    advisor: null,
    totalMemberCnt: 30,
...
const mockupClubList: z.infer<(typeof apiClb001.responseBodyMap)[200]> = {
  divisions: [
    {
      id: 1,
      name: "생활문화",
