  ...
  usageOrders: [
    {
      ...
      startTerm: new Date("2024-11-16T15:00:00Z"), // Start term as a date object
      endTerm: new Date("2024-11-23T15:00:00Z"), // End term as a date object
    },
    {
      orderId: 2, // Another example entry
      clubId: 30,
      chargeStudentName: "Jane Smith",
      startTerm: new Date("2024-11-16T15:00:00Z"),
      endTerm: new Date("2024-11-23T15:00:00Z"),
    },
  ],
};
